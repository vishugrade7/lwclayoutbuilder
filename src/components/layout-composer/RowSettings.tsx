    ...
    <>
      ...
      <div className="md:hidden w-full">
         <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="row-config">
                <AccordionTrigger className='py-2'>
                    <h2 className="text-base font-bold text-foreground whitespace-nowrap">Row Config</h2>
                </AccordionTrigger>
                <AccordionContent>
                    <div className="flex flex-col gap-4 pt-4">
                        <div className="flex items-center justify-between gap-2">
                            <Label htmlFor="multiple-rows-mobile" className="flex flex-col text-sm">
                            <span>Multiple Rows</span>
                            <span className="text-muted-foreground font-normal">{row.multipleRows ? 'Allowed' : 'Not-Allowed'}</span>
                            </Label>
                            <Switch
                                id="multiple-rows-mobile"
                                checked={row.multipleRows}
                                onCheckedChange={(checked) => handleUpdate({ multipleRows: checked })}
                            />
                        </div>
